...
final class Version20190304072212 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE page (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, date_created DATE NOT NULL, active TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE gallery ADD CONSTRAINT FK_472B783A7597D3FE FOREIGN KEY (member_id) REFERENCES member (id) ON DELETE CASCADE ON UPDATE RESTRICT');
        $this->addSql('ALTER TABLE image ADD CONSTRAINT FK_C53D045F4E7AF8F FOREIGN KEY (gallery_id) REFERENCES gallery (id)  ON DELETE SET NULL ON UPDATE RESTRICT');
        $this->addSql('ALTER TABLE image ADD CONSTRAINT FK_C53D045F7597D3FE FOREIGN KEY (member_id) REFERENCES member (id)  ON DELETE CASCADE ON UPDATE RESTRICT');
        ...
        $this->addSql('ALTER TABLE competition_image ADD CONSTRAINT FK_368A36893DA5256D FOREIGN KEY (image_id) REFERENCES image (id) ON DELETE CASCADE ON UPDATE RESTRICT');
